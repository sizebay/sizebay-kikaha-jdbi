...
import kikaha.db.ViburDatasourceProducer;
import lombok.extern.slf4j.Slf4j;
import org.jdbi.v3.core.Jdbi;
import org.vibur.dbcp.ViburDBCPDataSource;
import sizebay.kikaha.jdbi.serializers.AnnotatedEntityMapperFactory;
...
public class KikahaJDBIExtension implements CustomClassConstructor {
	...
	@Inject ViburDatasourceProducer dataSourceProducer;
	...
	private Jdbi createAJdbiConnection( String dataSourceName ){
		final ViburDBCPDataSource dataSource = this.dataSourceProducer.getCachedDataSources().get(dataSourceName);
		if ( dataSource == null )
